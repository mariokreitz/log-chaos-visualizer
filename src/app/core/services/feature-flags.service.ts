...
export class FeatureFlagsService {
    ...
    private readonly initial: FeatureFlagsState = {
        experimentalAnalysis: this.stored?.featureFlags?.experimentalAnalysis
          ?? APP_CONFIG.featureFlags.experimentalAnalysis,
        debugParsing: this.stored?.featureFlags?.debugParsing
          ?? APP_CONFIG.featureFlags.debugParsing,
    };
